          ...
          <div className="SearchBar">
            <input 
              ...
              <button type="button" className="search_btn" aria-label="검색" onClick={async () => {
                const list = await axios.get(`/ttb/api/ItemSearch.aspx?ttbkey=ttbrijamong08302251002&Query=${searchKeyword}&SearchTarget=Book&Version=2&output=js&maxResults=10`);
